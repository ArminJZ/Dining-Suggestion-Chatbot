...
def lambda_handler(event, context):
    ...
    cuisine = message[0]["messageAttributes"]["cuisine"]["stringValue"]
    phone_num = message[0]["messageAttributes"]["phone"]["stringValue"]
    location = message[0]["messageAttributes"]["location"]["stringValue"]
    dining_date = message[0]["messageAttributes"]["date"]["stringValue"]
    dining_time = message[0]["messageAttributes"]["time"]["stringValue"]
    num_people = message[0]["messageAttributes"]["peoplenum"]["stringValue"]
    ...
    #     TopicArn='arn:aws:sns:us-east-1:584092006642:Mike_ChatBot',
...
#
#     attempted_remain = 10
#     while not 'Messages' in response and attempted_remain >= 0:
#         logger.debug("response is null currently")
#
...
#             WaitTimeSeconds=0
#         )
#         logger.debug("This is the response of sqs")
